...
@section ('content')
    ...
    {{-- Hero --}}
        <div style="background-image: url({{ asset('images/contacto/hero_bg_contacto.jpg') }});" class=" bg-cover bg-center h-[600px] max-sm:h-[600px] flex items-center justify-center">
                    <h2 class="text-[48px] font-light text-white">Contacto</h2>
        </div>
    {{-- Hero end --}}

    {{-- Contactanos --}}
        <div class="w-[90vw] max-sm:w-[90vw] m-auto grid grid-cols-2 max-sm:grid-cols-1 gap-[40px] py-[40px]">
            <div class="flex justify-center items-start max-sm:items-center flex-col gap-[20px] ">
                <h2 class="text-blue text-[36px] max-sm:text-[28px] font-light">Contáctanos</h2>
                <div class="grid grid-cols-2 max-sm:grid-cols-1 gap-[20px] w-full">
                    <div class="flex flex-col gap-[10px]">
                        <h3 class="text-[24px] font-semibold text-blue">UBICACIÓN</h3>
                        <p class="text-[15px] font-light text-black">San Ramón, Alajuela</p>
                    </div>
                    <div class="flex flex-col gap-[10px]">
                        <h3 class="text-[24px] font-semibold text-blue">COMUNICATE</h3>
                        <p class="text-[15px] font-light text-black">Teléfono: +506 2233-4455 <br>
                        Correo: info@ticolancer.com</p>
                    </div>
                    <div class="flex flex-col gap-[10px]">
                        <h3 class="text-[24px] font-semibold text-blue">HORARIO</h3>
                        <p class="text-[15px] font-light text-black">Lunes a Sábado de 8:00 am -  6:00 pm</p>
                    </div>
                    <div class="flex flex-col gap-[10px]">
                        <h3 class="text-[24px] font-semibold text-blue">REDES SOCIALES</h3>
            ...
            <div class="flex max-sm:w-[90vw] justify-center items-center flex-col gap-[10px]">
                <div class="map-container">
                    <iframe
                        class="max-sm:w-[90vw] max-sm:h-[300px]" 
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15712.404982210874!2d-84.47943299101624!3d10.090789816178523!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8fa044e377d3afdb%3A0x25fec024d645683a!2sProvincia%20de%20Alajuela%2C%20San%20Ram%C3%B3n!5e0!3m2!1ses-419!2scr!4v1726609429344!5m2!1ses-419!2scr"
                        width="600" 
                        height="450" 
                        style="border:0;" 
                        allowfullscreen="" 
        ...
        <div class="flex w-full bg-blue py-[40px] flex-col">
            <div class="flex flex-col justify-center items-center m-auto w-[90vw] gap-[40px]">
                ...
                <form class="w-[50vw] max-sm:w-[90vw] flex flex-col gap-[20px]" action="{{ route('contacto.store') }}" method="POST">
                    ...
                    <input id="submit" type="submit" value="Enviar " class="rounded-[10px] cursor-pointer transition-all duration-500 ease-out hover:translate-y-[-5px] hover:bg-green w-fit bg-white px-[20px] py-[10px] text-primary text-[16px] font-semibold  outline-none">
                </form>
            </div>
        </div>
    {{-- Habla con nosotros end --}}
