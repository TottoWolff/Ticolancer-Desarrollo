...
<div class="w-full max-w-3xl mx-auto border-[1px] border-blue border-opacity-50 rounded-[16px] bg-white shadow-lg p-8 m-[140px]">
    ...
    <form action="{{ route('paymentMembership') }}" method="POST" id="payment-form" class="space-y-8 hidden">
        @csrf
        ...
        <div class="space-y-4">
            ...
            <div class="space-y-2">
                ...
                <input id="email" name="email" type="email" required class="mt-1 block w-full border-[0.5px] border-solid border-blue border-opacity-50 rounded-[10px] p-[10px] shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="ticolancer@email.com">
            </div>
        </div>
        ...
        <div class="space-y-4">
            ...
            <div class="space-y-4">
                <div class="space-y-2">
                    ...
                    <input id="card" name="card" type="text" required class="mt-1 block w-full border-[0.5px] border-solid border-blue border-opacity-50 rounded-[10px] p-[10px] shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="1234 1234 1234 1234">
                </div>
                <div class="grid grid-cols-2 gap-4">
                    <div class="space-y-2">
                        <label for="expiry" class="block text-sm font-medium text-gray-700">MM/AA</label>
                        <input id="expiry" name="expiry" type="text" required class="mt-1 block w-full border-[0.5px] border-solid border-blue border-opacity-50 rounded-[10px] p-[10px] shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="MM/AA">
                    </div>
                    <div class="space-y-2">
                        <label for="cvc" class="block text-sm font-medium text-gray-700">CVC</label>
                        <input id="cvc" name="cvc" type="text" required class="mt-1 block w-full border-[0.5px] border-solid border-blue border-opacity-50 rounded-[10px] p-[10px] shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="CVC">
                    </div>
                </div>
                <div class="space-y-2">
                    <label for="name" class="block text-sm font-medium text-gray-700">Nombre del titular de tarjeta</label>
                    <input id="name" name="card_name" type="text" required class="mt-1 block w-full border-[0.5px] border-solid border-blue border-opacity-50 rounded-[10px] p-[10px] shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="Nombre completo">
                </div>
            </div>
        </div>
        ...
        <div class="space-y-4">
            ...
            <div class="space-y-4">
                <div class="space-y-2">
                    ...
                    <select id="country" name="country" class="mt-1 block w-full border-[0.5px] border-solid border-blue border-opacity-50 rounded-[10px] p-[10px] shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                ...
                <div class="space-y-2">
                    ...
                    <input id="address1" name="address1" required type="text" class="mt-1 block w-full border-[0.5px] border-solid border-blue border-opacity-50 rounded-[10px] p-[10px] shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                </div>
                <div class="space-y-2">
                    <label for="address2" class="block text-sm font-medium text-gray-700">Línea 2 de dirección</label>
                    <input id="address2" name="address2" type="text" required class="mt-1 block w-full border-[0.5px] border-solid border-blue border-opacity-50 rounded-[10px] p-[10px] shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                </div>
                <div class="grid grid-cols-2 gap-4">
                    <div class="space-y-2">
                        <label for="city" class="block text-sm font-medium text-gray-700">Ciudad</label>
                        <input id="city" name="city" type="text" required class="mt-1 block w-full border-[0.5px] border-solid border-blue border-opacity-50 rounded-[10px] p-[10px] shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                    </div>
                    <div class="space-y-2">
                        <label for="postal" class="block text-sm font-medium text-gray-700">Código postal</label>
                        <input id="postal" name="postal" type="text" required class="mt-1 block w-full border-[0.5px] border-solid border-blue border-opacity-50 rounded-[10px] p-[10px] shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="space-y-4">
            <div class="flex items-center space-x-2">
                <input id="save-info" name="save_info" required type="checkbox" class="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500">
                <label for="save-info" class="text-sm text-gray-700">Acepto los términos y condiciones de Ticolancer</label>
            </div>
        </div>
