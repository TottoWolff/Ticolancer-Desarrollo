...
<div class="w-[90vw] bg-bg flex justify-center mt-[100px] m-auto">
    <div class="bg-bg rounded-lg w-full grid grid-cols-2 gap-[20px] max-sm:grid-cols-1">
        ...
        <div class="flex flex-col justify-start items-start gap-[20px] py-[20px]">
            <a
                class="flex w-full items-center gap-[10px] justify-center border-[1px] border-blue border-opacity-50 rounded-[12px] p-[10px] text-white bg-blue transition-all duration-500 hover:translate-y-[-5px]">Cuenta</a>
            <a class="flex w-full items-center gap-[10px] justify-center border-[1px] border-blue border-opacity-50 rounded-[12px] p-[10px] text-blue hover:text-white hover:bg-blue hover:border-blue transition-all duration-500 hover:translate-y-[-5px] "
                href="{{ route('sellerProfileSettingsSecurity', ['username' => $username]) }}">Seguridad</a>
            <a class="text-[16px] text-blue underline hover:text-green transition-all duration-500 ease-out"
                href="{{ route('sellerProfile', ['username' => $username]) }}">🡠 Ir a mi perfil</a>
        ...
        <div class="w-full flex-col flex py-[20px] gap-[20px]">
            ...
            <form action="{{ route('sellers.updatePersonalInfo', ['username' => $username]) }}" method="POST"
                ...
                <div class="flex items-center justify-between">
                    ...
                    <input type="text" name="name" id="name" value="{{ $name }}" placeholder="{{ $name }}"
                        class="outline-none bg-transparent border-[0.5px] border-solid border-blue border-opacity-50 rounded-[10px] p-[10px] w-[80%]">
                </div>
                <!-- lastname -->
                <div class="flex items-center justify-between">
                ...
                <!-- birthdate -->
                <div class="flex items-center justify-between">
                    <label for="birthdate" class="text-[14px] font-light">CUMPLEAÑOS</label>
                    <div class="flex items-center justify-between w-[80%] gap-[20px]">
                        <input type="date" name="userBirthdate" id="userBirthdate" value="{{ $sellerBirthdate }}"
                            placeholder="{{ $sellerBirthdate }}"
                            class="outline-none bg-transparent border-[0.5px] border-solid border-blue border-opacity-50 rounded-[10px] p-[10px] w-[30%]">
                    </div>
                </div>
            ...
            <!-- Contact information -->
            <form action="{{ route('sellers.updateContactInfo', ['username' => $username]) }}" method="POST"
                class="w-full flex flex-col p-[20px] gap-[20px] border-[0.5px] border-solid border-blue border-opacity-50 rounded-[16px]">
                @csrf
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center justify-between w-[80%] gap-[20px]">
                        <input type="text" readonly value="+506"
                            class="outline-none bg-transparent border-[0.5px] border-solid border-blue border-opacity-50 rounded-[10px] p-[10px] w-[20%]">
            ...
            <!-- address -->
            <form action="{{ route('sellers.updateAddress', ['username' => $username]) }}" method="POST"
                class="w-full flex flex-col p-[20px] gap-[20px] border-[0.5px] border-solid border-blue border-opacity-50 rounded-[16px]">
                @csrf
                ...
                <div class="flex items-center gap-[20px] w-full">
                    ...
                    <div class="flex items-center w-full gap-[20px]">
                        <input type="text" name="sellerAddress" id="phone" value="{{ $sellerAddress }}"
                            placeholder="{{ $sellerAddress }}"
                            class="outline-none bg-transparent border-[0.5px] border-solid border-blue border-opacity-50 rounded-[10px] p-[10px] w-[90%]">
                    </div>
            ...
            <!-- location -->
            <form action="{{ route('sellers.updateLocation', ['username' => $username]) }}" method="POST"
                class="w-full flex flex-col p-[20px] gap-[20px] border-[0.5px] border-solid border-blue border-opacity-50 rounded-[16px]">
                @csrf
                ...
                <div class="flex items-center gap-[20px]">
                    ...
                    <select name="province" id="province"
                        class="text-[14px] font-light uppercase outline-none bg-transparent border-[0.5px] border-solid border-blue border-opacity-50 rounded-[10px] p-[10px] w-full">
                        <option selected disabled class="text-[14px] font-light uppercase" value=""> {{$userProvince }}
                        </option>
                        @foreach ($provinces as $province)
                            <option class="text-[14px] font-light uppercase" value="{{ $province->id }}">
                    ...
                    <select name="city" id="city"
                        class="text-[14px] font-light uppercase outline-none bg-transparent border-[0.5px] border-solid border-blue border-opacity-50 rounded-[10px] p-[10px] w-full">
                        <option selected disabled class="text-[14px] font-light uppercase" value="">{{$userCity }}
                        </option>
                        @foreach ($cities as $city)
                            <option class="text-[14px] font-light uppercase" value="{{ $city->id }}">{{ $city->city }}
                            </option>
                        @endforeach
                    </select>

                    <button class="submit"><img class="w-[26px]" src="{{ asset('icons/close-blue.svg') }}"
                            alt=""></button>
                </div>
            ...
            <!-- Social media -->
            <form action="{{ route('sellers.updateSocialMedia', ['username' => $username]) }}" method="POST"
                class="w-full flex flex-col p-[20px] gap-[20px] border-[0.5px] border-solid border-blue border-opacity-50 rounded-[16px]">
                @csrf
                ...
                <div class="flex items-center justify-between">
                    ...
                    <input type="url" name="facebook" id="facebook" value="{{ $sellerFacebook }}"
                        placeholder="{{ $sellerFacebook }}"
                        class="outline-none bg-transparent border-[0.5px] border-solid border-blue border-opacity-50 rounded-[10px] p-[10px] w-[80%]">
                </div>
                <!-- Instagram -->
                <div class="flex items-center justify-between">
                    <label for="instagram" class="text-[14px] font-light">INSTAGRAM</label>
                    <input type="url" name="instagram" id="instagram" value="{{ $sellerInstagram }}"
                        placeholder="{{ $sellerInstagram }}"
                        class="outline-none bg-transparent border-[0.5px] border-solid border-blue border-opacity-50 rounded-[10px] p-[10px] w-[80%]">
                </div>
                <!-- Twitter -->
                <div class="flex items-center justify-between">
                    <label for="twitter" class="text-[14px] font-light">TWITTER</label>
                    <input type="url" name="twitter" id="twitter" value="{{ $sellerTwitter }}"
                        placeholder="{{ $sellerTwitter }}"
                        class="outline-none bg-transparent border-[0.5px] border-solid border-blue border-opacity-50 rounded-[10px] p-[10px] w-[80%]">
                </div>
                <!-- Linkedin -->
                <div class="flex items-center justify-between">
                    <label for="linkedin" class="text-[14px] font-light">LINKEDIN</label>
                    <input type="url" name="linkedin" id="linkedin" value="{{ $sellerLinkedin }}"
                        placeholder="{{ $sellerLinkedin }}"
                        class="outline-none bg-transparent border-[0.5px] border-solid border-blue border-opacity-50 rounded-[10px] p-[10px] w-[80%]">
                </div>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <input name="website" id="website" placeholder="{{ $sellerWebsite }}"
                        class="outline-none bg-transparent border-[0.5px] border-solid border-blue border-opacity-50 rounded-[10px] p-[10px] w-[80%]">
                </div>
            ...
            <form action="{{ route('sellers.desactivateAccount', ['username' => $username]) }}" method="POST"
                ...
                <div class="flex flex-col items-start justify-center gap-[20px]">
                    ...
                    <div class="flex items-center justify-between w-full">
                        ...
                        <select name="reason" id="reason"
                            class="text-[14px] font-light outline-none bg-transparent border-[0.5px] border-solid border-blue border-opacity-50 rounded-[10px] p-[10px] w-full">
                ...
                <div class="items-end justify-center flex flex-col w-full gap-[10px]">
                    <button type="submit"
                        class="w-fit bg-red-600 rounded-[10px] p-[10px] text-white font-semibold text-[14px] hover:translate-y-[-5px] transition-all duration-500 ease-out">Desactivar</button>
                </div>
