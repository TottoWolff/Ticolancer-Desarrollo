<header>
    <div class="z-[999] h-[100px] flex fixed top-0 w-full left-[50%] -translate-x-1/2 m-auto py-[20px] max-sm:py-[20px] px-[120px] max-sm:px-[20px] items-center justify-between font-main font-semibold text-[18px]  transition-all duration-500 ease-out bg-bg">
        ...
        <ul class="flex flex-row gap-[10px] max-sm:hidden">
            ...
            <li class="p-[10px] hover:text-white border-[1px] border-blue rounded-[10px] hover:bg-blue transition-all duration-500 hover:translate-y-[-5px] ease-out"><a href="{{ route('admin.sellers') }}">Vendedores</a></li>
            <li class="p-[10px] hover:text-white border-[1px] border-blue rounded-[10px] hover:bg-blue transition-all duration-500 hover:translate-y-[-5px] ease-out"><a href="{{ route('admin.applications') }}">Solicitudes</a></li>
